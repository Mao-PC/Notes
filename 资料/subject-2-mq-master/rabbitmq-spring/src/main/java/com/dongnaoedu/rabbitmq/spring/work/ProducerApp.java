package com.dongnaoedu.rabbitmq.spring.work;
...
public class ProducerApp {
    private static final Logger logger = LoggerFactory.getLogger(com.dongnaoedu.rabbitmq.spring.simple.ProducerApp.class);
